...
catch { config_ip_cache -export [get_ips -all ${design_name}_sobel_accel_0_0] }
...
launch_runs ${design_name}_processing_system7_0_0_synth_1 ${design_name}_sobel_accel_0_0_synth_1 ${design_name}_auto_pc_0_synth_1 ${design_name}_rst_ps7_0_50M_0_synth_1 ${design_name}_auto_pc_1_synth_1 ${design_name}_auto_us_0_synth_1 -jobs 8
